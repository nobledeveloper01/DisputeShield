"""RLS for the widget tables. ENABLE plus FORCE, as in every earlier phase."""

from django.db import migrations

PROTECTED_TABLES = [
    "disputeshield_allowedorigin",
    "disputeshield_widgetconfig",
]
...
class Migration(migrations.Migration):
    dependencies = [("disputeshield", "0009_apikey_kind_allowedorigin_widgetconfig")]
