"""RLS for the phase 7 tables. ENABLE plus FORCE, as in every earlier phase."""

from django.db import migrations

PROTECTED_TABLES = [
    "disputeshield_ingestaddress",
    "disputeshield_disputecontact",
    "disputeshield_inboundmessage",
    "disputeshield_incident",
    "disputeshield_incidentsubscription",
    "disputeshield_massevent",
    "disputeshield_masseventmembership",
]
...
class Migration(migrations.Migration):
    dependencies = [("disputeshield", "0015_incident_incidentsubscription_ingestaddress_and_more")]
